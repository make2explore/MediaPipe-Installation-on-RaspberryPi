...
- A Raspberry Pi (preferably 4 or 400 for better performance) with Raspberry Pi OS (32-bit or 64-bit) installed.  
- An active internet connection.  
- A terminal or SSH access to your Raspberry Pi.  
- At least 10GB of free storage (preferably on a microSD card or external drive).  
